...
export default function MapView() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden">
      ...
      {loc && (
        <div className="absolute bottom-0 left-0 w-full md:w-96 md:bottom-auto md:top-20 md:left-4 bg-white z-[1000] rounded-t-2xl md:rounded-2xl shadow-[0_-4px_10px_rgba(0,0,0,0.1)] md:shadow-xl transition-transform duration-300 transform">
          <div className="p-5 flex flex-col gap-3 relative">
            ...
            <div className="flex gap-3 mt-1">
              <button onClick={getDirections} className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-full flex items-center justify-center gap-2 transition shadow-sm">
              ...
              <button onClick={() => {
                  ...
                  alert("Link copied!");
              }} className="flex-1 bg-gray-100 hover:bg-gray-200 text-blue-700 font-medium py-2 px-4 rounded-full flex items-center justify-center gap-2 transition shadow-sm border border-gray-200">
